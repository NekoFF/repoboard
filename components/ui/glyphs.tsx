...
/** GitHub's mark, for "Sign in with GitHub" (drawn in the current text colour). */
export function GitHubMark({ size = 16, className = "" }: { size?: number; className?: string }) {
  return (
    <svg width={size} height={size} viewBox="0 0 16 16" className={`shrink-0 ${className}`} fill="currentColor" aria-hidden>
